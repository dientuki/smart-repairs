...
<x-filament-panels::layout.base :livewire="$livewire">
    ...
    <div class="fi-layout flex flex-col min-h-screen w-full overflow-x-clip gap-2 ">
        ...
        <div class="fi-topbar sticky top-0 z-1 overflow-x-clip flex flex-row justify-between bg-white dark:bg-gray-900  shadow-sm ring-1 ring-gray-950/5 dark:ring-white/10">
