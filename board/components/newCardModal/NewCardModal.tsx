      ...
      <div className='flex flex-row h-full relative z-50'>
        ...
        <div className='basis-1/4'>
          ...
          <div className='border border-gray-300 p-3 rounded mt-4'>
            <p className='my-2'>
              Fecha de entrada: {date.toDateString()}{" "}
          ...
          <div className='border border-gray-300 p-3 rounded mt-4'>
            <p className='my-2'>
              Cliente: {createOrderSelectedData.customer?.label}{" "}
            </p>
            <p className='my-2'>
              {createOrderSelectedData.deviceTypeLabel
                ? createOrderSelectedData.deviceTypeLabel
                : "Equipo"}
              : {createOrderSelectedData.deviceLabel}
            </p>
          </div>
        </div>
      </div>
