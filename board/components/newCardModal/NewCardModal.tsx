...
import { TabStatusEnum, TypedColumn } from "@/types/enums";
      ...
      {!isLoading && (
          <div className='flex flex-row flex-grow border-t border-gray-200 dark:border-white/10 px-5 py-3 text-base min-h-0'>
            <div className='basis-3/4 p-2 pr-4 mr-3 flex flex-col gap-6 overflow-y-scroll min-h-full max-h-full'>
              ...
              >
                <TabList data-f="ol" className='grid divide-y divide-gray-200 dark:divide-white/5 md:grid-flow-col md:divide-y-0 md:overflow-x-auto border-b border-gray-200 dark:border-white/10'>

                  <TabListTab
                    index={1}
                    title="Cliente"
                    subtitle="Informacion del cliente"
                    status={TabStatusEnum.Active} />
                  <TabListTab
                    index={2}
                    title="Equipo"
                    subtitle="Informacion del equipo"
                    status={TabStatusEnum.Inactive} />
                  <TabListTab
                    index={3}
                    title="Problema"
