  ...
  return (
    <div className="rounded-xl shadow-sm ring-1 ring-gray-950/5 dark:ring-white/10 bg-white dark:bg-white/5">
      <div className="flex flex-row justify-between gap-3 cursor-pointer p-3" onClick={toggleClasses}>
        ...
        <div className={`relative flex items-center justify-center rounded-lg outline-none transition duration-75 focus-visible:ring-2 -m-2 h-9 w-9 text-gray-400 hover:text-gray-500 focus-visible:ring-primary-600 dark:text-gray-500 dark:hover:text-gray-400 dark:focus-visible:ring-primary-500 ${isToggled ? 'rotate-180' : 'rotate-0'}`}>
          <Icon size={5} icon={ChevronUpIcon}  />
        </div>
      </div>

      <div className={`border-t border-gray-200 dark:border-white/10 p-3 ${isToggled ? 'invisible absolute h-0 overflow-hidden border-none' : ''}`}>
