...
export const OrderUsers = () => {
  ...
  return (
    <>
      ...
      <div style={dynamicStyles(StyleColor.Primary)} className="pl-9 hover:underline cursor-pointer flex items-center self-end w-2/3 font-semibold text-sm text-custom-600 dark:text-custom-400"><span className="first-letter:uppercase">{t('order.assign_to_me')}</span></div>
