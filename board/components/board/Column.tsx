              ...
              >
                <div className='relative flex items-center justify-between gap-x-3 rounded-t-lg py-2 px-3 outline-none transition duration-75 bg-gray-50 dark:bg-white/5'>
                  ...
                  <span
                    ...
                    className='flex items-center justify-center gap-x-1 rounded-md text-xs font-medium ring-1 ring-inset px-2 min-w-[theme(spacing.6)] py-1 fi-color-custom bg-custom-50 text-custom-600 ring-custom-600/10 dark:bg-custom-400/10 dark:text-custom-400 dark:ring-custom-400/30 fi-color-primary'
                  >
                    {orders.length}
                  </span>
                </div>
